...
val spark = SparkSession.builder().appName("ExcerciseSolution").config("spark.master", "local").getOrCreate()

// Use Spark to read in the Ecommerce Customers csv file.
val data = spark.read.option("header","true").option("inferSchema","true").format("csv").load("Regression/Ecommerce Customers")
